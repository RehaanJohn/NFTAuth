...
• Verify: ${window.location.origin}/verify?token=${tokenId}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 py-8 transition-colors duration-300">
